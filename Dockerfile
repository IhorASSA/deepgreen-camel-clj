...
ADD packages/deepgreen-file-importer/requirements.txt /opt/deepgreen-camel-clj/packages/deepgreen-file-importer/
...
RUN pip3 install --user -r packages/deepgreen-file-importer/requirements.txt
